...
/*		w.get("https://demo.testfire.net/login.jsp");
	...
	*/
	...
	public void tabFlipkart() throws Exception {
       ...
       Set<String> window_ids=w.getWindowHandles();
       
       System.out.println(window_ids);
       
       Object [] win_id=window_ids.toArray();
       
       System.out.println(win_id[0]);
       System.out.println(win_id[1]);
       
       w.switchTo().window(win_id[0].toString());
       System.out.println("Tab 1 title : "+w.getTitle());
       
       Thread.sleep(2000);
       
       w.switchTo().window(win_id[1].toString());
